    ...
    <div className=' min-h-screen min-w-screen flex flex-col justify-center bg-amber-100 ' >
        <div>
            ...
            <div className=' mt-10 w-108rem h-69.8125rem flex flex-col space-y-3 px-3 min-w-full justify-between bg-slate-200 '>
              ...
              {questionDetails.pairs.map((key)=>(
                <div className=' bg-pink-200 flex justify-between'>
                  <div className='border border-solid border-gray-200 rounded-md w-48 h-20 text-3xl flex items-center justify-center text-center bg-slate-50 drop-shadow-lg'>{key[0]}</div>
                  <div className='border border-solid border-gray-200 rounded-md w-48 h-20 text-3xl flex items-center justify-center text-center bg-slate-50 drop-shadow-lg'>{key[1]}</div>
                </div>
              ))}
            </div>
        </div>
